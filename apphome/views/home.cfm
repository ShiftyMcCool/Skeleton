<!--- 
<cfset Sample = getProperty("serviceFactory").getBean('SampleService') />
<cfdump var="#Sample#" />

<cfdump var="#event.getArg('Sample')#" />
 --->
...
<body>
	<img src="assets/img/machiiLogo.gif" width="229" height="60" alt="Mach-II" />
